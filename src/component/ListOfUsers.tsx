...
export default function ListOfUsers() {
  ...
  //el .users viene del store/index.tsx ya que agremos un reducer con la key de users
          ...
          <TableBody>
            {users.map((item) => (
              <TableRow key={item.name}>
                ...
                <TableCell style={{display: 'flex',alignItems: 'center', borderRadius: '50%', marginRight: '8px',}}>
                    <img 
